function C = getCoordinates(obj,trajectories)
...
Option = obj.Option;
Result = trajectories; % obj.Result is normal
...
%         elseif isfield(Molecule,'centroid')
    ...
    C{i,1} = moleculeTrajectoryCoordinates;
    if strcmp(flag,'obj.Result')
        C{i,2} = Result(i).Motility_flag;
        C{i,3} = Result(i).Aggregate_flag;
    end
