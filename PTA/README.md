...
Developed in The Lab for Nanobiotechnology by Megan Armstrong and Dr. Siheng He  
Department of Biomedical Engineering  
School of Engineering and Applied Science  
Columbia University  

## What is the purpose of this directory?
The files here are designed to locate and parameterize beads in an image or image sequence. 
...
Output: An PTA object with properties **Filename**, **Option**, **Molecule**, **Frame**, **Result**, and **Intensity** [more added in recent edits].
